...
|----|-----------|--------|----------|
| S1 | [Observability & Transaction Visibility](S1_OBSERVABILITY.md) | Planning | P0 |
| S2 | [Bill Disappearance Resolution](S2_BILL_DISAPPEARANCE.md) | Planning | P0 |
| S3 | [Pipeline Modularity & Chain Testing](S3_PIPELINE_CHAINS.md) | Planning | P1 |
| S4 | [Bill Attribution & User Tracking](S4_BILL_ATTRIBUTION.md) | Planning | P1 |
| S5 | [Functional Validation Audit](S5_FUNCTIONAL_AUDIT.md) | Planning | P1 |
